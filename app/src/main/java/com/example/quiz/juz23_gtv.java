...
public class juz23_gtv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juz23_gtv);
    ...
    public void quiz(View v) {
        switch (q) {
            case 0: {
                ...
                tv1.setText("لَا يَسْتَطِيعُونَ نَصْرَهُمْ وَهُمْ لَهُمْ جُندٌ مُّحْضَرُونَ");
                a.setText("Yasin : 25");
                b.setText("As-Shaffat : 94");
                c.setText("Yasin : 75");
                no.setText("1");
            ...
            case 1: {
                tv1.setText("اصْلَوْهَا الْيَوْمَ بِمَا كُنتُمْ تَكْفُرُونَ");
                a.setText("Az-Zumar : 23");
                b.setText("Yasin : 64");
                c.setText("Shad : 25");
                ...
                if (c.isChecked()) {
                    ...
                    tv2.setText("C was the right answer, Yasin : 75");
                }
                q = 2;
                a.setChecked(false);
                b.setChecked(false);
            ...
            case 2: {
                ...
                if (b.isChecked()) {
                    ...
                    tv2.setText("B was the right answer, Yasin : 64");
                }
